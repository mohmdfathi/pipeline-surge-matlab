...
thin-wall hoop stress and approximate valve thrust. Grid independence was
checked directly within the live script rather than as a separate study. The
case data are synthetic but physically plausible and are intended as a
transparent engineering study rather than the design of a particular
installation.
...
- `analysis_valve_timing.mlx` — live script: steady operating point, MOC
  ...
  envelopes, vapor-pressure margin, hoop stress, approximate actuator thrust)
